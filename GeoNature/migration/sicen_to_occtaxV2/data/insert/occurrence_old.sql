...
INSERT INTO pr_occtax.t_occurrences_occtax(
    ...
    ref_nomenclatures.get_id_nomenclature('STATUT_OBS', oo.cd_nomenclature_observation_status) AS id_nomenclature_observation_status,
    ...
    COALESCE(s.cd_nom_valid, oo.cd_nom) AS cd_nom,
    ...
    LEFT JOIN export_oo.t_taxonomie_synonymes s
        ON s.cd_nom_invalid = oo.cd_nom